...
Changes:
* Fix: improved hyperlink activation handling, interception of navigation events and browser window creation
* NPM package updates

Git revision info:
* https://unpkg.com/r2-navigator-js@1.25.4/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.25.4/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.25.4

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.25.3...v1.25.4
...
Changes:
* Added shell.openExternal safeguard (https?:// URL protocol only)
* Hyperlinks in PDF (and some scripted EPUBs) could be clicked with COMMAND or SHIFT which opened a separate orphan Thorium window (ALT / OPTION triggers the download action), now solved with WebContents.setWindowOpenHandler() alongside the will-navigate event
* The CFI roundtrip checker (only in DEV mode) was using the global window.document instead of the actual parsed document (causing false negatives during text search in Thorium, and even crashes in some cases)
* The special URL scheme that encodes publication UUID as host using underscores to marks uppercase characters has a converter that was not forcing lowercase syntax.

Git revision info:
* https://unpkg.com/r2-navigator-js@1.25.2/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.25.2/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.25.2

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.25.1...v1.25.2
...
Changes:
* NPM package updates
* Fixed security hole: Electron contextIsolation

Git revision info:
* https://unpkg.com/r2-navigator-js@1.25.1/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.25.1/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.25.1

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.25.0...v1.25.1
...
Git revision info:
* https://unpkg.com/r2-navigator-js@1.23.1/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.23.1/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.23.1

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.23.0...v1.23.1
...
Git revision info:
* https://unpkg.com/r2-navigator-js@1.23.0/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.23.0/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.23.0

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.22.2...v1.23.0
...
Git revision info:
* https://unpkg.com/r2-navigator-js@1.22.2/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.22.2/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.22.2

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.22.1...v1.22.2
...
Git revision info:
* https://unpkg.com/r2-navigator-js@1.22.0/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.22.0/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.22.0

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.21.1...v1.22.0
...
Git revision info:
* https://unpkg.com/r2-navigator-js@1.20.14/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.20.14/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.20.14

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.20.13...v1.20.14
...
Git revision info:
* https://unpkg.com/r2-navigator-js@1.20.13/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.20.13/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.20.13

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.20.12...v1.20.13
...
Git revision info:
* https://unpkg.com/r2-navigator-js@1.20.12/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.20.12/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.20.12

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.20.11...v1.20.12
...
Git revision info:
* https://unpkg.com/r2-navigator-js@1.20.9/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.20.9/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.20.9

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.20.8...v1.20.9
...
Git revision info:
* https://unpkg.com/r2-navigator-js@1.20.8/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.20.8/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.20.8

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.20.7...v1.20.8
...
Git revision info:
* https://unpkg.com/r2-navigator-js@1.20.7/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.20.7/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.20.7

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.20.6...v1.20.7
...
Git revision info:
* https://unpkg.com/r2-navigator-js@1.20.5/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.20.5/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.20.5

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.20.4...v1.20.5
...
Git revision info:
* https://unpkg.com/r2-navigator-js@1.20.4/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.20.4/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.20.4

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.20.3...v1.20.4
...
Git revision info:
* https://unpkg.com/r2-navigator-js@1.20.3/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.20.3/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.20.3

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.20.2...v1.20.3
...
Git revision info:
* https://unpkg.com/r2-navigator-js@1.20.0/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.20.0/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.20.0

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.19.5...v1.20.0
...
Git revision info:
* https://unpkg.com/r2-navigator-js@1.19.5/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.19.5/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.19.5

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.19.4...v1.19.5
...
Git revision info:
* https://unpkg.com/r2-navigator-js@1.19.2/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.19.2/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.19.2

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.19.1...v1.19.2
...
Git revision info:
* https://unpkg.com/r2-navigator-js@1.17.5/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.17.5/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.17.5

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.17.4...v1.17.5
...
Git revision info:
* https://unpkg.com/r2-navigator-js@1.17.3/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.17.3/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.17.3

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.17.2...v1.17.3
...
Git revision info:
* https://unpkg.com/r2-navigator-js@1.17.1/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.17.1/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.17.1

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.17.0...v1.17.1
...
Git revision info:
* https://unpkg.com/r2-navigator-js@1.17.0/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.17.0/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.17.0

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.16.7...v1.17.0
...
Git revision info:
* https://unpkg.com/r2-navigator-js@1.16.7/dist/gitrev.json
* https://github.com/edrlab/r2-navigator-js-dist/blob/v1.16.7/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-navigator-js/commits/v1.16.7

Git diff:
* https://github.com/readium/r2-navigator-js/compare/v1.16.6...v1.16.7
